        ...
        <section id="About" className="bg-[#E3E3E3] dark:bg-gray-800">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center rounded-lg bg-primary-700 dark:text-white border-gray-300 hover:bg-primary-800">
                        Resume 
                        <TbFileDownload />
                    </a>
